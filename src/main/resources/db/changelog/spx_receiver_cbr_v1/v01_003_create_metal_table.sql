...
INSERT INTO cbr.metal(source_code, source, instr_name, instr_name_eng, created) VALUES
(1, 'METAU-CBRF', 'Золото, учетные цены на драгоценные металлы', 'Gold Reference Prices', now()),
